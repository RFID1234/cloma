...
$(document).ready(function() {
    $("#form_sendemail").submit(function() {
        return $.ajax({
            ...
            success: function(n) {
                n.error && (n.error.name && ($('#form_sendemail input[name="name"]').parent().addClass("has-error"),
                $('#form_sendemail input[name="name"]').next(".help-block").html(n.error.name).slideDown()),
                n.error.email && ($('#form_sendemail input[name="email"]').parent().addClass("has-error"),
                $('#form_sendemail input[name="email"]').next(".help-block").html(n.error.email).slideDown()),
                n.error.message && ($('#form_sendemail textarea[name="message"]').parent().addClass("has-error"),
                $('#form_sendemail textarea[name="message"]').next(".help-block").html(n.error.message).slideDown()));
                n.success && ($("#form_message").addClass("alert-success").html(n.success).slideDown(),
                setTimeout(function() {
